...
const Home = () => {
  ...
  const fetchTasks = async () => {
    try {
      ...
      const response = await fetch('https://taskapi2.onrender.com/api/auth/getTasks', {
        method: 'GET',
        headers: {
  ...
  const handleCreateTask = async () => {
    if (newTask.title.trim()) {
      try {
        ...
        const response = await fetch('https://taskapi2.onrender.com/api/auth/tasks', {
          method: 'POST',
          headers: {
  ...
  const handleEditTask = async () => {
    if (editTask && newTask.title.trim()) {
      try {
        ...
        const response = await fetch(`https://taskapi2.onrender.com/api/auth/tasks/${editTask.id}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
            Authorization: `Bearer ${token}`,
  ...
  const handleUpdateStatus = async (taskId, newStatus) => {
    try {
      ...
      const response = await fetch(`https://taskapi2.onrender.com/api/auth/tasks/${taskId}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
